...
func (fake *ExtractContainer) OpenReaderReturnsOnCall(i int, result1 *zip.ReadCloser, result2 error) {
	fake.OpenReaderStub = nil
...
func (fake *ExtractContainer) TempDirReturnsOnCall(i int, result1 string, result2 error) {
	fake.TempDirStub = nil
...
func (fake *ExtractContainer) MkdirAllReturnsOnCall(i int, result1 error) {
	fake.MkdirAllStub = nil
...
func (fake *ExtractContainer) OpenFileReturnsOnCall(i int, result1 *os.File, result2 error) {
	fake.OpenFileStub = nil
...
func (fake *ExtractContainer) CopyReturnsOnCall(i int, result1 int64, result2 error) {
	fake.CopyStub = nil
...
func (fake *ExtractContainer) MatchReturnsOnCall(i int, result1 bool, result2 error) {
	fake.MatchStub = nil
