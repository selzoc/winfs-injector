...
type Extractor struct {
	ExtractWindowsFSReleaseStub        func(inputTile string, outputDir string) (string, error)
	...
	extractWindowsFSReleaseReturnsOnCall map[int]struct {
		result1 string
		result2 error
	}
...
func (fake *Extractor) ExtractWindowsFSRelease(inputTile string, outputDir string) (string, error) {
	...
	ret, specificReturn := fake.extractWindowsFSReleaseReturnsOnCall[len(fake.extractWindowsFSReleaseArgsForCall)]
...
func (fake *Extractor) ExtractWindowsFSReleaseReturnsOnCall(i int, result1 string, result2 error) {
	fake.ExtractWindowsFSReleaseStub = nil
	if fake.extractWindowsFSReleaseReturnsOnCall == nil {
		fake.extractWindowsFSReleaseReturnsOnCall = make(map[int]struct {
			result1 string
			result2 error
		})
	}
	fake.extractWindowsFSReleaseReturnsOnCall[i] = struct {
		result1 string
		result2 error
	}{result1, result2}
}
